 ...
 *
 * <p>本项目 {@code WebhookDeliveryService}、{@code KafkaEventStore}、
 * {@code DeadLetterQueueService} 等组件仍通过构造函数注入 Jackson 2.x
 * {@code ObjectMapper}。此配置类提供兼容 bean，使其在 Spring Boot 4.0 下继续可用。</p>
 *
