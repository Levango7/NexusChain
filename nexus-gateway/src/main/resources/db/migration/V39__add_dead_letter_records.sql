...
CREATE TABLE IF NOT EXISTS dead_letter_records (
    ...
    payload         TEXT         NOT NULL COMMENT '原始 Webhook payload（JSON 字符串）',
    ...
    created_at      TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '转入死信队列时间',
    last_retry_at   TIMESTAMP(6) NULL DEFAULT NULL COMMENT '最后重试时间',
    PRIMARY KEY (id),
