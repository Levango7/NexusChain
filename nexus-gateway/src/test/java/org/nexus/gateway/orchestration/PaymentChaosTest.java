...
class PaymentChaosTest {
    ...
    void signingServiceIntermittent_thenSuccess() {
        try (MockedStatic<WalletUtils> mockedWalletUtils = mockStatic(WalletUtils.class)) {
            mockedWalletUtils.when(() -> WalletUtils.addressToPubkeyHash("0xPayee_chaos2")).thenReturn("payeeHash");
            mockedWalletUtils.when(() -> WalletUtils.addressToPubkeyHash("0xPayer_chaos2")).thenReturn("payerHash");
    ...
    void walletServiceDown_thenRecover() {
        try (MockedStatic<WalletUtils> mockedWalletUtils = mockStatic(WalletUtils.class)) {
            ...
            mockedWalletUtils.when(() -> WalletUtils.addressToPubkeyHash("0xPayee_chaos3")).thenAnswer(inv -> {
    ...
    void cascadingFailure_signingAndChain_thenRecover() {
        try (MockedStatic<WalletUtils> mockedWalletUtils = mockStatic(WalletUtils.class)) {
            mockedWalletUtils.when(() -> WalletUtils.addressToPubkeyHash("0xPayee_chaos4")).thenReturn("payeeHash");
            mockedWalletUtils.when(() -> WalletUtils.addressToPubkeyHash("0xPayer_chaos4")).thenReturn("payerHash");
    ...
    void signingTimeout_thenRecover() {
        try (MockedStatic<WalletUtils> mockedWalletUtils = mockStatic(WalletUtils.class)) {
            mockedWalletUtils.when(() -> WalletUtils.addressToPubkeyHash("0xPayee_chaos5")).thenReturn("payeeHash");
            mockedWalletUtils.when(() -> WalletUtils.addressToPubkeyHash("0xPayer_chaos5")).thenReturn("payerHash");
