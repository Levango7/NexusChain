...
public class PeersManager implements Plugin {
    ...
    private static final NexusChainOuterClass.Pong PONG = NexusChainOuterClass.Pong.newBuilder().build();
    ...
    private void onLookup(Context context, PeerServer server) {
        ...
        context.response(NexusChainOuterClass.Peers.newBuilder().addAllPeers(peers).build());
    }
