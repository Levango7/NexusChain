...
package org.nexus.keystore.crypto.ed25519;

import org.bouncycastle.asn1.x9.X9ECParameters;
import org.bouncycastle.crypto.ec.CustomNamedCurves;
import org.bouncycastle.jce.provider.BouncyCastleProvider;
import org.bouncycastle.jce.spec.ECParameterSpec;
import org.nexus.keystore.crypto.CryptoException;
...
public class Curve25519ECDH implements ECDH{
    ...
    public byte[] generateSecretKey(byte[] publicKey) throws CryptoException {
        org.nexus.keystore.crypto.PublicKey publicKey1 = new org.nexus.keystore.crypto.PublicKey(publicKey, algorithm, format);
