...
import org.nexus.account.PublicKeyHash;
import org.nexus.consensus.pow.EconomicModel;
import org.nexus.consensus.pow.ProposersState;
...
public class NodeInfoController {
    ...
    @Value("${nexus.allow-miner-joins-era}")
    ...
    private static class Account {
        ...
        public Account(byte[] publicKeyHash, long nonce, long balance, long incubateCost, long mortgage, long votes) {
            ...
            this.nonce = nonce;
            this.balance = balance * 1.0 / EconomicModel.NEX + " NEX";
            this.incubateCost = incubateCost * 1.0 / EconomicModel.NEX + " NEX";
            this.mortgage = mortgage * 1.0 / EconomicModel.NEX + " NEX";
            this.votes = votes * 1.0 / EconomicModel.NEX + " NEX";
