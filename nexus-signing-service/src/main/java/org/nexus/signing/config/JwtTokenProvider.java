 ...
 *
 * <p>P1-F1 安全加固：signing-service 内嵌的 JWT Provider，与 nexus-core
 * {@code org.nexus.util.JWTUtil} 对齐 jjwt 0.12.x API，但密钥从
 * {@code nexus.security.jwt.secret} 配置项读取（生产环境通过环境变量
 * {@code JWT_SECRET} 注入），不再硬编码。</p>
 *
