...
public class KeyGenRoundMessageTest {
    ...
    public void testBuilderAndGetters() {
        ...
        assertEquals(msg.getPaillierNHex(), "n-hex");
        assertEquals(msg.getPaillierGHex(), "g-hex");
        assertEquals(msg.getEncryptedShareHex(), "enc-hex");
        assertEquals(msg.getZkProofHex(), "zk");
        assertEquals(msg.getPublicKeyShareHex(), "pk-share");
    }
