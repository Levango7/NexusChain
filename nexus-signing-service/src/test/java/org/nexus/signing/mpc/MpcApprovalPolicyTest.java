...
public class MpcApprovalPolicyTest {
    ...
    public void testGetRequiredApproversNullAmountThrows() {
        policy.getRequiredApprovers(null, "NEX");
    }

    @Test(expected = IllegalArgumentException.class)
    public void testGetRequiredApproversZeroAmountThrows() {
        policy.getRequiredApprovers(BigDecimal.ZERO, "NEX");
    }

    @Test(expected = IllegalArgumentException.class)
    public void testGetRequiredApproversNegativeAmountThrows() {
    ...
    public void testCanSignNullAmountThrows() {
