...
public class MpcSignerTest {
    ...
    @Test
    public void testNullSharesThrows() { assertThrows(NullPointerException.class, () -> {
        signer.runSigningRounds(newSession(2, 2), null);
        });
    }

    @Test
    public void testQuorumNotReachedThrows() { assertThrows(MpcProtocolException.class, () -> {
