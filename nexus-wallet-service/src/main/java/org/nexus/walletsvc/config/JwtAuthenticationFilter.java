 ...
 *
 * <p>P0-3 安全加固：从 {@code Authorization: Bearer <jwt>} 头解析 JWT，
 ...
 *
 * <p>本类与 signing-service 的
 * {@code org.nexus.signing.config.JwtAuthenticationFilter} 逻辑一致，
 * 但不含遗留角色归一化（wallet-service 无 P1-F1 遗留角色兼容需求）。</p>
 */
@Component
