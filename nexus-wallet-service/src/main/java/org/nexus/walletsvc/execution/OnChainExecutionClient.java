 ...
 *
 * <p>迁移历史：原位于 {@code org.nexus.wallet.wallet.execution.OnChainExecutionClient}
 * （nexus-exchange-wallet），在 Phase 2 微服务化中迁移至 nexus-wallet-service
 * （新包 {@code org.nexus.walletsvc.execution}）。方法签名引用的 DTO 已迁移至
 * {@code org.nexus.sdk.wallet} 共享包。</p>
 */
